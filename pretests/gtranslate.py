# Translator to connect to Google Translate API paid service: Obtained from: https://gist.github.com/jseabold/1473363
...
api = 'AIzaSyBLVh2FHZtdIw6NTqYJIndO3xiqwH67eJ0'
...
class GoogleTranslator(object):
    ...
    results1 = translator.translate("Einen schnen Tag allerseits")
 
    # try 2 at a time
    results2 = translator.translate(["Einen schnen Tag allerseits",
                                     "Ich nehme an"])
 
    # try detect
    results3 = translator.detect("Einen schnen Tag allerseits")
 
    # try to detect 2 at a time
    results4 = translator.detect(["Einen schnen Tag allerseits",
                                     "Ich nehme an"])
    """
    def __init__(self):
